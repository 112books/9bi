---
title: "Incorpora't a 9 Barris Imatge"
description: "Com crear el teu compte i enviar-nos les teves dades per accedir al gestor de continguts"
url: "/incorpora-te/"
hiddenInRss: true
build:
  list: 'never'
...
<form class="contact-form" action="https://formsubmit.co/info@9barrisimatge.org" method="POST">
  ...
  <input id="nom-complet" type="text" name="nom_complet" required autocomplete="name" placeholder="Joan Martínez i Serres">
  ...
  <label for="web">Web personal, blog o pàgina de fotografia (opcional)</label>
  <input id="web" type="url" name="web" autocomplete="url" placeholder="https://www.exemple.cat">

  <label for="instagram">Instagram (opcional)</label>
  <input id="instagram" type="url" name="instagram" placeholder="https://www.instagram.com/el-teu-usuari/">

  <label for="galeries">Altres galeries o xarxes (Google Fotos, Amazon Fotos, Flickr, Facebook…)</label>
  <textarea id="galeries" name="galeries" rows="3" placeholder="Un enllaç per línia, o descriu on publiques les teves fotos"></textarea>

  <div class="contact-consent">
    <input id="consentiment" type="checkbox" name="consentiment" value="sí" required>
    <label for="consentiment">He llegit i accepto la <a href="/privacitat/">política de privacitat</a> i que les meves dades es tractin per gestionar el meu perfil de membre.</label>
  </div>

  <button type="submit">Envia les dades</button>
</form>
