...
| --- |
|  |
| De [Bricomania; construint una taula de retrat macro](https://picasaweb.google.com/103138221614479310970/BricomaniaConstruintUnaTaulaDeRetratMacro?authuser=0&feat=embedwebsite) |

Avui, sobretot gràcies al manetes de l'Oscar, hem iniciat el muntatge d'aquesta taula-estructura per a poder fer ratrats "macro". Encara falta, però ja hem fet les primeres còpies cutres ;)
